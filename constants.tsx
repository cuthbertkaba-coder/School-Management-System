...
const IconWrapper: React.FC<{ children: React.ReactNode }> = ({ children }) => (
  <span className="w-6 h-6 mr-3 text-slate-500 group-hover:text-blue-600 transition-colors duration-200">
    {children}
  </span>
);
...
export const NAV_ITEMS = [
  ...
  { label: Page.Staff, icon: ICONS.Staff, roles: [Role.Admin, Role.Headteacher] },
  { label: Page.ClassRecords, icon: ICONS.ClassRecords, roles: [Role.Admin, Role.Teacher, Role.Headteacher, Role.SMCChair] },
  { label: Page.Examinations, icon: ICONS.ExaminationsGrades, roles: [Role.Admin, Role.Teacher, Role.Headteacher, Role.SMCChair] },
  { label: Page.Financials, icon: ICONS.FeesFinancials, roles: [Role.Admin, Role.Headteacher] },
  ...
  { label: Page.Settings, icon: ICONS.SchoolSettings, roles: [Role.Admin, Role.Headteacher] },
];